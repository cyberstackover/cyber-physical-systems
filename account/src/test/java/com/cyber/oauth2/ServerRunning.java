...
public class ServerRunning implements MethodRule, RestTemplateHolder {
    ...
    private static String DEFAULT_HOST = "iout-er2c.com";
    ...
    public Statement apply(final Statement base, FrameworkMethod method, Object target) {
        ...
        try {
            client.getForEntity(new UriTemplate(getUrl("/account/login")).toString(), String.class);
            online = true;
        ...
        postForStatus(savedClient, "/account/oauth/uncache_approvals", new LinkedMultiValueMap<String, String>());
        ...
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                try {
                    ...
                    postForStatus(savedClient, "/account/oauth/cache_approvals",
