...
@Description(
        ...
        + " > 16843009")
public class GenericIPToLong extends GenericUDF {
     ...
     * to get the actual argument Object. The Objects can be inspected by the
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException {
        ...
        return new LongWritable(IPToLong(t.toString()));
    }
